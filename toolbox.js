!(function (t, e) {
  ...
  return (function (t) {
    ...
    function o(s) {
      ...
      return t[s].call(i.exports, i, i.exports, o), (i.l = !0), i.exports;
    }
    return (
      (o.m = t),
      (o.c = e),
    ...
    function (t, e, o) {
      "use strict";
      o.r(e),
        o.d(e, "ContinuousCategory", function () {
          return i;
        }),
        o.d(e, "ContinuousFlyout", function () {
          return n;
        }),
        o.d(e, "ContinuousMetrics", function () {
          return l;
        }),
        o.d(e, "ContinuousToolbox", function () {
          return r;
        });
      var s = o(0);
      /**
        ...
        setSelected(t) {
          t
            ? ((this.rowDiv_.style.backgroundColor = "gray"),
              s.utils.dom.addClass(this.rowDiv_, this.cssConfig_.selected))
            : ((this.rowDiv_.style.backgroundColor = ""),
              s.utils.dom.removeClass(this.rowDiv_, this.cssConfig_.selected)),
            s.utils.aria.setState(
              this.htmlDiv_,
              s.utils.aria.State.SELECTED,
              t
            );
        }
      }
      s.registry.register(
        ...
        s.ToolboxCategory.registrationName,
        i,
        !0
      );
      /**
      ...
      class r extends s.Toolbox {
        ...
        getInitialFlyoutContents_() {
          ...
          for (const e of this.contents_)
            if (e instanceof s.ToolboxCategory) {
              t.push({ kind: "LABEL", text: e.getName() });
              let o = e.getContents();
              "string" == typeof o && (o = { custom: o, kind: "CATEGORY" }),
                (t = t.concat(o));
            }
          return t;
        }
        ...
        getCategoryByName(t) {
          const e = this.contents_.find(
            (e) =>
              e instanceof s.ToolboxCategory &&
              e.isSelectable() &&
              t === e.getName()
          );
          return e || null;
       ...
       * SPDX-License-Identifier: Apache-2.0
       */
      class n extends s.VerticalFlyout {
        constructor(t) {
          super(t),
        ...
        getCategoryScrollPosition(t) {
          ...
          return (
            console.warn(`Scroll position not recorded for category ${t}`), null
          );
        }
        ...
        calculateBottomPadding_(t) {
          if (this.scrollPositions.length > 0) {
            const e =
                this.scrollPositions[this.scrollPositions.length - 1].position
                  .y * this.workspace_.scale,
              o = t.contentHeight - e;
            if (o < t.viewHeight) return t.viewHeight - o;
          }
          return 0;
        }
        getMetrics_() {
          const t = super.getMetrics_();
          return t && (t.contentHeight += this.calculateBottomPadding_(t)), t;
        }
        setMetrics_(t) {
          super.setMetrics_(t),
            this.scrollPositions &&
        ...
        position() {
          ...
          (i =
            this.targetWorkspace.toolboxPosition == this.toolboxPosition_
              ? t.toolboxWidth
                ? this.toolboxPosition_ == s.TOOLBOX_AT_LEFT
                  ? t.toolboxWidth
                  : t.viewWidth
                : this.toolboxPosition_ == s.TOOLBOX_AT_LEFT
                ? 0
            ...
            this.positionAt_(this.width_, this.height_, i, 0);
        }
        show(t) {
          super.show(t), this.emptyRecycleBlocks_();
        }
        emptyRecycleBlocks_() {
        ...
        createBlock_(t) {
          const e = t.getAttribute("type"),
            o = this.recycleBlocks_.findIndex(function (t) {
              return t.type === e;
            });
          let i;
          return (
            (i =
              o > -1
                ? this.recycleBlocks_.splice(o, 1)[0]
                : s.Xml.domToBlock(t, this.workspace_)),
            i.isEnabled() || this.permanentlyDisabled_.push(i),
            i
          );
        }
        clearOldBlocks_() {
          ...
          for (const e of t)
            e.workspace == this.workspace_ &&
              (this.recyclingEnabled_ && this.blockIsRecyclable_(e)
                ? this.recycleBlock_(e)
                : e.dispose(!1, !1));
          for (const t of this.mats_)
            t && (s.Tooltip.unbindMouseEvents(t), s.utils.dom.removeNode(t));
          this.mats_.length = 0;
        ...
        blockIsRecyclable_(t) {
          if (t.mutationToDom && t.domToMutation) return !1;
          for (const e of t.inputList) {
            for (const t of e.fieldRow) {
              if (t instanceof s.FieldVariable) return !1;
              if (t instanceof s.FieldDropdown && t.isOptionListDynamic())
                return !1;
            }
            if (e.connection) {
       ...
       * SPDX-License-Identifier: Apache-2.0
       */ class l extends s.MetricsManager {
        constructor(t) {
          super(t);
        }
        getViewMetrics(t) {
          ...
          return (
            this.workspace_.getToolbox() &&
              (n == s.TOOLBOX_AT_TOP || n == s.TOOLBOX_AT_BOTTOM
                ? (o.height -= i.height + r.height)
                : (n != s.TOOLBOX_AT_LEFT && n != s.TOOLBOX_AT_RIGHT) ||
                  (o.width -= i.width + r.width)),
            {
              height: o.height / e,
              width: o.width / e,
      ...
      s.registry.register(
        s.registry.Type.METRICS_MANAGER,
